...
function App() {
    ...
    return (
        <div className="text-center p-20 w-full max-w-[900px] ml-auto mr-auto">
            <h1 className="font-bold uppercase text-yellow-400 mb-10"><span className="block text-6xl">Random</span> <span className="block text-8xl">Chuck Norris</span> <span className="block text-6xl">Joke Generator</span></h1>
            ...
            <div className="mb-10">
                <label className="mr-3" htmlFor="categories">Or chose a category:</label>
            ...
            <p className="text-yellow-400 text-4xl">{joke}</p>
        </div>
    )
}
